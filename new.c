#define z (k + j*I)/512			// define the complex variable, devide or multiply by real value to zoom or by imaginary value to rotate and zoom, add or subtract value to scroll 
#define CDP (12 * log(pow(256,5)))	// color depth. Adjust by the Expression
#define EXP clog(z) 			// the Expression to be plotted. Must be described using complex.h functions, or other complex valued functions.
